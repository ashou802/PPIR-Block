...
def define_G(opt):
    ...
    # CotSwinIR
    # ----------------------------------------
    elif net_type == 'Cotswinir':
        from models.network_Cotswinir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
        ...
        # CotSwinIR
        # ----------------------------------------
    elif net_type == 'CCotswinir':
        from models.network_CCotswinir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'CotswinirL':
        from models.network_CotswinirL import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'LCotswinirL':
        from models.network_LCotswinirL import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'LLCotswinirL':
        from models.network_LLCotswinirL import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
